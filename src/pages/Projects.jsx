...
import ConstructionPattern from "../components/ConstructionPattern";
    ...
    <main>
      ...
      <svg className="fullHex center" viewBox="0 0 100 86">
        ...
        <g className="projHex">
          ...
          <a className="triLink" href="https://nellienelson.com/ringsTrue/">
            <polygon
              className="shape underConstruction"
              points="50 43, 75 86, 100 43"
              strokeWidth="0"
              fill="url(#constructionIcon)"
            ></polygon>
            <text
              x="60"
              y="40"
      ...
      <svg className="fullHex left" viewBox="0 0 100 86">
        <g className="projHex">
          ...
          <a className="triLink" href="https://nellienelson.com/Cut-Up-Poems/">
            <polygon
              className="shape"
              points="50 43, 75 86, 100 43"
              strokeWidth="0"
