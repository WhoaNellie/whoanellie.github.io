...
export default function ConstructionPattern() {
  return (
    <defs>
      <pattern
        id="constructionIcon"
        ...
        width="50"
        height="50"
        patternTransform="rotate(60, 50, 43)"
      >
        <rect width="50" height="50" fill="#fbf8e5" />

        <g transform="translate(12, 6) scale(0.2)" style={{ opacity: "0.75" }}>
          <path
            ...
            stroke="#4ba2b2"
            strokeWidth="8.43"
            transform="matrix(1 0 0 .89399 0 12.085)"
          />

          <g fill="#4ba2b2" fillRule="nonzero">
